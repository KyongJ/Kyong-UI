/*
 * @Author: your name
 * @Date: 2022-03-31 09:40:26
 * @LastEditTime: 2022-03-31 11:34:34
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: /tinkerbell-ui-react/src/packages/Upload/ajax.tsx
 */
...
// 解析错误
function getError(action: string, _option: any, xhr: XMLHttpRequest) {
...
export default function upload(option: {
  action: any
  onProgress: (arg0: ProgressEvent<EventTarget>) => void
  data: {[x: string]: string | Blob}
  filename: string
  file: string | Blob
